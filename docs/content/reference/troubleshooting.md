...
Most of these come down to network reality or how crossref serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

crossref rate-limits like any public site. crossref already paces
...
Where a surface is gated, crossref reads a cookie or token you supply
...
`crossref`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what crossref actually did
